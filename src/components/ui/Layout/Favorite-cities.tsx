...
function FavoriteCityTable({id, name, lat, lon, onRemove}: FavoriteCityTableProps) {
    ...
    return (
        ...
        className='relative flex min-w-[250px] cursor-pointer items-center gap-3 rounded-lg border bg-card p-4 pr-8 shadow-sm transform-all hover:shadow-md'>
